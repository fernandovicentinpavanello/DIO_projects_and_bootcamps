...
// nome = valor; isso não vai funcionar. O tipo unknown não pode ser arbitrariamente atribuido
...
valorAny = true;
valorAny = 10;
nome = valorAny; // o perigo é que o any pode ser atribuído a qualquer variável tipada sem que seu tipo seja varificado
