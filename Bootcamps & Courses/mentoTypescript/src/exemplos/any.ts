...
// E aqui passamos a variável cpf que contém um number, mas com ela é um any, o TS não reclama porque ela pode conter qualquer atributo, inclusive uma string
apresentarCPF(cpf);
...
/*
    ...
    É uma má prática quie reduz a velocidade dos times no longo prazso e foge do propósito do typescript
